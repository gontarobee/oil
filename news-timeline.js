...
const NEWS_DATED = [
  {
    date: '2026-09-16',
    title: '中東情勢を踏まえた緊急的激変緩和措置：9月17日以降の支給単価を更新',
    source: '資源エネルギー庁（経済産業省）',
    url: 'https://nenryo-teigakuhikisage.go.jp/',
    summary:
      '9月17日以降2週間の支給単価として、ガソリン・軽油・灯油・重油を51.0円/L、航空機燃料を40.8円/Lに設定した旨の公表更新。170円/ℓ程度への抑制を継持するための措置で、2022年の補助開始以降の過去最高水準と報道等で説明されている（確定の算定根拠は公式ページの資料で確認）。',
    note: '新着情報欄に9/16更新の記載。全国平均小売価格の調査は資エネ庁の石油製品価格調査。',
  },
  {
    date: '2026-09-16',
    title: '石油備蓄の状況（推計値の速報）令和8年9月16日公表（9月13日時点）',
    source: '資源エネルギー庁（経済産業省）',
    url: 'https://www.enecho.meti.go.jp/statistics/petroleum_and_lpgas/pl001/pdf-oil-res/oil_daily.pdf',
    summary:
      '推計値の速報として、データ時点9月13日時点の合計201日分（国家102・民間94・産油国共同4）が示されている旨の公表更新（表の区分に基づく運営側の要約。確定の内訳・定義はPDFの表で確認）。',
    note: '一覧ページは pl001/。速報PDFは毎営業日更新の oil_daily.pdf。',
  },
  {
    date: '2026-09-01',
    title: '令和8年度一般会計中東情勢等対応予備費使用（閣議決定）',
    source: '財務省',
    url: 'https://www.mof.go.jp/policy/budget/budger_workflow/budget/fy2026/r80901kakugikettei.pdf',
    summary:
      '中東情勢等対応予備費から合計616,010,601千円（約6160億円）の使用を閣議決定。内訳は燃料油価格激変緩和対策事業613,639,094千円（経済産業省）と、タクシー事業者向けLPガス価格激変緩和対策2,371,507千円（国土交通省）。使用後の残額は1,883,989,399千円。',
    note: '閣議案件一覧は首相官邸 kakugi-2026090101。要求書一覧は財務省 fy2026 ページ。',
  },
  {
    date: '2026-09-14',
    title: '石油備蓄の状況（推計値の速報）令和8年9月14日公表（9月11日時点）',
    source: '資源エネルギー庁（経済産業省）',
    url: 'https://www.enecho.meti.go.jp/statistics/petroleum_and_lpgas/pl001/pdf-oil-res/oil_daily.pdf',
    summary:
      '推計値の速報として、データ時点9月11日時点の合計201日分（国家103・民間94・産油国共同4）が示されている旨の公表更新（表の区分に基づく運営側の要約。確定の内訳・定義はPDFの表で確認）。',
    note: '一覧ページは pl001/。速報PDFは毎営業日更新の oil_daily.pdf。',
  },
  {
    date: '2026-08-31',
    title: '石油統計速報 令和8年7月分',
    source: '資源エネルギー庁（経済産業省）',
    url: 'https://www.meti.go.jp/statistics/tyo/sekiyuso/result.html',
    summary:
      '7月の原油輸入量は1,172万kl、前年同月比117.0%と2か月連続で前年を上回った旨の公表。中東依存度は58.9%で、前年同月比28.7ポイント減と10か月連続で前年を下回ったとしている。',
    note: '月次速報の公表日は8月31日。ページは最新月に更新されるため、7月分の表は同ページ内のPDF/Excelで確認。',
  },
  {
    date: '2026-08-26',
    title: '第17回 GX実行会議',
    source: '首相官邸（総理の一日）',
    url: 'https://www.kantei.go.jp/jp/105/actions/202608/26gx.html',
    summary:
      '中東情勢の影響を受ける重要物資の供給状況とエネルギー需給構造の強靱化について議論。総理は、石油製品の目詰まり相談が劇的に減少し収束に向かっていること、緊急的激変緩和措置による物価抑制、パワーＧＸとしての調達多角化・化石燃料依存低減の加速を述べている。',
  },
  {
    date: '2026-08-25',
    title: '「中東情勢を踏まえた緊急的激変緩和措置」及び「物価高対策」等についての会見',
    source: '首相官邸（総理の演説・記者会見）',
    url: 'https://www.kantei.go.jp/jp/105/statement/2026/0825kaiken.html',
    summary:
      '中東情勢が不透明で原油価格の見通しが困難な状況を踏まえ、中東情勢等対応予備費を活用してガソリン価格を引き続き全国平均170円/ℓ程度に抑制する方針を表明。8月17日時点の実績169.8円、補助がなければ約187円だった旨も説明している。',
  },
  {
    date: '2026-07-13',
    title: '石油備蓄の状況（推計値の速報）令和8年7月13日公表（7月10日時点）',
    source: '資源エネルギー庁（経済産業省）',
    url: 'https://www.enecho.meti.go.jp/statistics/petroleum_and_lpgas/pl001/pdf-oil-res/oil_daily.pdf',
    summary:
      '推計値の速報として、データ時点7月10日時点の合計201日分（国家104・民間93・産油国共同4）が示されている旨の公表更新（表の区分に基づく運営側の要約。確定の内訳・定義はPDFの表で確認）。',
    note: '一覧ページは pl001/。速報PDFは毎営業日更新の oil_daily.pdf。',
  },
  {
    date: '2026-07-10',
    title: '金子大臣会見要旨',
    source: '国土交通省（大臣会見）',
    url: 'https://www.mlit.go.jp/report/interview/daijin260710.html',
    summary:
      '7月7〜9日に日本関係船舶22隻がホルムズ海峡を通過し、そのうち6隻は日本向け大型原油タンカーだったと公表。乗組員・船体に異常はなく、ペルシャ湾内に残る日本関係船舶は当初45隻から4隻になったとしている。',
    note: '会見の「中東情勢について」に記載。',
  },
  {
    date: '2026-07-07',
    title: '金子大臣会見要旨',
    source: '国土交通省（大臣会見）',
    url: 'https://www.mlit.go.jp/report/interview/daijin260707.html',
    summary:
      '7月4〜6日に日本関係船舶5隻がホルムズ海峡を通過し、乗組員・船体に異常はないと公表。これにより、ペルシャ湾内に残る日本関係船舶は26隻になったとしている。',
    note: '会見の「中東情勢について」に記載。',
  },
  {
    date: '2026-07-03',
    title: '金子大臣会見要旨',
    source: '国土交通省（大臣会見）',
    url: 'https://www.mlit.go.jp/report/interview/daijin260703.html',
    summary:
      '7月1日に日本関係船舶1隻がホルムズ海峡を通過し、乗組員・船体に異常はないと公表。これにより、ペルシャ湾内に残る日本関係船舶は31隻になったとしている。',
    note: '会見の「中東情勢について」に記載。',
  },
  {
    date: '2026-06-26',
    title: '第11回 中東情勢に関する関係閣僚会議',
    source: '首相官邸（総理の一日）',
    url: 'https://www.kantei.go.jp/jp/105/actions/202606/26kaigi_middle-east.html',
    summary:
      'ナフサ由来の化学製品を含む石油製品は年度を越えて供給継続が可能との見通しを示し、シンナー・潤滑油・医療物資などの流通の目詰まり解消策を確認。自由で透明なエネルギー貿易、石油備蓄の国際協調、産油国と消費国の連携強化というG7合意にも触れている。',
  },
  {
    date: '2026-06-11',
    title: '第10回 中東情勢に関する関係閣僚会議',
    source: '首相官邸（総理の一日）',
    url: 'https://www.kantei.go.jp/jp/105/actions/202606/11kaigi_middle-east.html',
    summary:
      'ホルムズ海峡を経由しない原油の代替調達について、7月は前年平月比で約10割への回復にめどがつき、7月に必要な量を上回る見通しから国家備蓄を追加放出しない方針を説明。8月以降の代替調達を前年平月比75％とする保守的な仮定でも、備蓄活用により2028年3月末まで安定供給が可能との試算を示している。',
  },
  {
    date: '2026-05-25',
...
const DATA_SOURCE_HUBS = [
  ...
  {
    title: '中東情勢を踏まえた緊急的激変緩和措置（燃料油価格支援）',
    summary:
      'ガソリン・軽油等の支給単価、全国平均小売価格の推移、措置の概要を掲載する資エネ庁の公式ページ。170円/ℓ程度への抑制を目的とした補助の入口。',
    note: '支給単価はおおむね2週間ごとに更新。算定方法の資料も同ページから。',
    source: '資源エネルギー庁（経済産業省）',
    url: 'https://nenryo-teigakuhikisage.go.jp/',
  },
];
